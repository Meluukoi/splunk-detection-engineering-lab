...
# Investigation 6: User Activity Timeline
...
Construct a user activity timeline by correlating authentication events, process execution, DNS activity, and network connections using Windows Security and Sysmon telemetry.

## Investigation Methodology

The investigation correlated multiple event sources to reconstruct endpoint activity:
...
The investigation reconstructed endpoint activity by correlating Windows Security and Sysmon telemetry collected through Splunk.

Analysis identified:

- Successful user authentication
- PowerShell execution activity
- Child process creation (`whoami.exe`)
- DNS resolution activity
- Outbound network communications

The resulting timeline provided a sequential view of user activity occurring on the endpoint.
...
This investigation demonstrates how multiple telemetry sources can be correlated to reconstruct user behavior and support incident response activities.
...
![Successful Logon](screenshots/successful-logon-investigation.png)

### PowerShell Process Analysis

![PowerShell Analysis](screenshots/powershell-investigation.png)

### DNS Activity Analysis

![DNS Analysis](screenshots/dns-activity-investigation.png)

### Network Connection Analysis

![Network Analysis](screenshots/network-connection-analysis.png)
